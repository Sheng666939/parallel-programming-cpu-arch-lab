...
void multiplyByNttLargeCRTModParallel(
    ...
    for (int modulusIndex = 0;
        ...
        prepareCrtStageRootTableMontgomery(
            transformLength,
            modulusIndex,
            false
        );
        ...
        numberTheoreticTransformCrtModMontgomeryPrepared(
...
int main(int argc, char *argv[])
{
    ...
    std::cout << "32-bit Pthread whole-pipeline + large-modulus CRT V10-4 thread count = "<< threadCount << std::endl;
    int test_begin = 0;
    int test_end = 4;
